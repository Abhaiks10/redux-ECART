...
import { removeItem } from "../redux/slices/wishlist";
import { emptyCart, removeToCart } from "../redux/slices/cartSlice";
              ...
              <tbody>
                {cartArray.map((item, index) => (
                  <tr className="text-center" key={index}>
                    ...
                    <td className="border border-gray-300 p-3">
                      <button onClick={()=>dispatch(removeToCart(item?.id))} className="bg-red-500 text-white p-2 rounded-full">
                        <FaTrash />
                      </button>
                    </td>
                  </tr>
